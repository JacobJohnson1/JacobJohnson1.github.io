            ...
            <div className='parentBlogDiv'>
                <div className='blogText'>
                    <p className='blogParagraph'>
                        ...
                        If the fix is cheap, aesthetically pleasing, and/or over-engineered, then I'm gonna be stoked about it. 
                        <br></br>
                        &emsp; The problem that I aimed to fix recently is a problem with my keyboard. It is always on. Unless I unplug it (annoying) 
                        or I lock my computer (not always possible). Here are two common scenarios I find myself in that will explain my plight. 
                        </p>
                        <ol>
                            <li>I'm in a meeting and my cat wants to join. She hops on my desk and walks around. Her brain is small and she does not 
                        understand what a keyboard is or that she really should not walk on one. She walks on it and now I am looking at a 
                        different screen and I have left the meeting. I am now having a bad time.</li>
                            <li>I walk away from my desk for a moment to get another cup of coffee. Again the cat thing happens. Now the files
                        I was working on are all deleted and I am again having a bad time.</li>
                        </ol>
                        <p>
                        <br></br>
                        ...
                        <br></br><br></br>
                        &emsp;Hopefully this entire site is a way for me to preserve events, projects, and items that produce that feeling. And I hope
                        if you're here reading this that you get that feeling secondhand. 
                    </p>
                </div>
